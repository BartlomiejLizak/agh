...
int main() {
	...
	//for (int i = 3; i > 0; i--) // tworzmy pętle for aby dać 3 sznase na wpisanie hasła
	//{ 
	//cout << "podaj haslo: ";
	//cin >> podane;
	...
	//	while (wybor != 2)  // robimy pętle while aby dać opcje wyboru.
	//	{
	...
	//else
	//{
	//	cout << "Bledne haslo! zostalo " << i - 1  << " prob" << endl;
	//}
	//}
